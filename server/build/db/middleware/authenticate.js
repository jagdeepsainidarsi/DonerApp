...
var authenticate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, verifyToken, rootUser, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model.findOne({ _id: verifyToken._id, "tokens.token": token })];
            case 1:
                rootUser = _a.sent();
                if (!rootUser) {
            ...
            case 2:
                err_1 = _a.sent();
                res.status(402).json({msg:"unauthorized no token pribided"});
                console.log(err_1);
                return [3 /*break*/, 3];
